      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                That's why every coaching plan starts with a <span className="text-[#49c274] font-semibold">free strategy call</span> — 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="relative border border-[#2e9e4f]/50 rounded-2xl p-6 bg-[#12201a] flex flex-col">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">Full coaching for 3 months. Real results, real accountability.</p>
            </div>

            <div className="mb-2">
              <div className="text-4xl font-bold text-[#49c274]">$499<span className="text-lg text-muted-foreground font-normal">/3mo</span></div>
              <div className="text-muted-foreground text-sm mt-1">~$166/month</div>
            </div>
            <div className="bg-[#2e9e4f]/10 border border-[#2e9e4f]/30 rounded-lg px-3 py-2 mb-6">
              <span className="text-[#49c274] text-sm font-bold">30 days FREE trial</span>
              <span className="text-muted-foreground text-sm"> — cancel before and pay $0</span>
            </div>
          ...
          <div className="relative border-2 border-[#2e9e4f] rounded-2xl p-6 bg-[#12201a] flex flex-col shadow-2xl shadow-[#2e9e4f]/20">
            ...
            <div className="mb-6 mt-2">
              ...
              <p className="text-muted-foreground text-sm">6 months of full transformation. Where real change happens.</p>
            </div>

            <div className="mb-2">
              <div className="text-4xl font-bold text-[#49c274]">$999<span className="text-lg text-muted-foreground font-normal">/6mo</span></div>
              <div className="text-muted-foreground text-sm mt-1">~$166/month</div>
            </div>
            <div className="bg-[#2e9e4f]/10 border border-[#2e9e4f]/30 rounded-lg px-3 py-2 mb-6">
              <span className="text-[#49c274] text-sm font-bold">30 days FREE trial</span>
          ...
          <div className="relative border border-red-500/50 rounded-2xl p-6 bg-[#12201a] flex flex-col">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">Full year. Maximum results. For those who are serious.</p>
            </div>

            <div className="mb-2">
              <div className="text-4xl font-bold text-red-400">$1,999<span className="text-lg text-muted-foreground font-normal">/yr</span></div>
              <div className="text-muted-foreground text-sm mt-1">~$166/month</div>
            </div>
        ...
        <div className="bg-[#12201a] border border-[#2e9e4f]/30 rounded-2xl p-8 mb-12 text-center">
          <p className="text-muted-foreground text-lg">
            ...
            For just <span className="text-[#49c274] font-bold">$499</span> you get <span className="text-white font-bold">3 full months</span> of coaching — 
            with a <span className="text-[#49c274] font-bold">30-day free trial</span>. 
            The math is obvious.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center mb-12">
          <div className="bg-[#12201a] rounded-xl p-6">
            ...
            <div className="text-2xl font-bold text-[#49c274] mb-2">30-Day Trial</div>
            <p className="text-muted-foreground text-sm">Start free — cancel anytime before day 30 and pay nothing</p>
          </div>
          <div className="bg-[#12201a] rounded-xl p-6">
            <div className="flex justify-center mb-3">
          ...
          <div className="bg-[#12201a] rounded-xl p-6">
            ...
            <div className="text-2xl font-bold text-[#49c274] mb-2">Free Strategy Call</div>
            <p className="text-muted-foreground text-sm">15 minutes to see if we're the right fit — no obligation</p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="bg-[#12201a] rounded-xl p-6">
              ...
              <p className="text-muted-foreground text-sm">Because real transformation requires a personalized approach. During our 15-minute strategy call, I'll understand your goals, current situation, and challenges. This way, I can tell you honestly if my coaching is the right fit — and which plan makes the most sense for you.</p>
            </div>
            <div className="bg-[#12201a] rounded-xl p-6">
              <h3 className="font-bold text-white mb-2">How does the 30-day free trial work?</h3>
              <p className="text-muted-foreground text-sm">After our call, if we decide to work together, you start immediately. I begin working with you from day one. If you cancel before day 30, you pay nothing. After day 30, your subscription begins automatically.</p>
            </div>
            <div className="bg-[#12201a] rounded-xl p-6">
              <h3 className="font-bold text-white mb-2">What's the difference between the plans?</h3>
              <p className="text-muted-foreground text-sm">The longer the plan, the deeper the transformation. 3 months gets you started with solid foundations. 6 months builds real, lasting habits. 12 months changes your life permanently. We'll discuss which one is right for you during the call.</p>
            </div>
            <div className="bg-[#12201a] rounded-xl p-6">
